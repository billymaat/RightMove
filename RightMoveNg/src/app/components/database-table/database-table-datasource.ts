...
export class DatabaseTableDataSource extends DataSource<DatabaseTableItem> {
   ...
   */
  connect(): Observable<DatabaseTableItem[]> {
   ...
   */
  private getPagedData(data: DatabaseTableItem[]): DatabaseTableItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: DatabaseTableItem[]): DatabaseTableItem[] {
